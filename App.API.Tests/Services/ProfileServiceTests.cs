...
namespace App.API.Tests.Services
{
    ...
    public class ProfileServiceTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _mockTripService = new Mock<IAppUserTripService>();
            _mockAppUserService = new Mock<IAppUserService>();
            _profileService = new ProfileService(_mockLogger.Object, _mockProfileRepository.Object, _mockTripService.Object, _mockAppUserService.Object);
        ...
        public async Task GetProfileByIdAsyncValidIdReturnsProfile()
        {
            ...
            var testProfileDto = await _testProfile.ConvertProfileObjectToResponseDto(_testProfile);

            var expectedResult = Result<ProfileResponseDto>.Success(testProfileDto);
        ...
        public async Task UpdateProfileValidIdUpdatesProfile()
        {
            ...
            var profileDto = await _testProfile.ConvertProfileObjectToResponseDto(_testProfile);
