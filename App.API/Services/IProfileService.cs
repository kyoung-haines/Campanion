...
namespace App.API.Services
{
    public interface IProfileService
    {
        ...
        public Task<Result<List<AppUserFavouriteCampground>>> RetrieveProfileUserFavouriteCampgrounds(AppUserFavouriteCampgroundService appUserFavouriteCampgroundService, AppUser appUser);
        public Task<Result<List<AppUserTrip>>> RetrieveProfileOwnerUpcomingTrips(AppUser appUser);
    }
}